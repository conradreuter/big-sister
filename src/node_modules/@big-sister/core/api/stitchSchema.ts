...
export default function stitchSchema(
  ...
  async function exportt(
  ...
  ): Promise<{ data: string, fileExtension: string, mimeType: string }> {
    ...
    return {
      ...
      fileExtension: exportt.fileExtension,
      mimeType: exportt.mimeType,
    }
  }
  ...
  function knownIdentifiers(
    ...
    return store.readKnownIdentifiers()
  }
