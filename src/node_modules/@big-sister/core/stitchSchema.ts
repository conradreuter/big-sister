import { Export, Extension, Interval, Store, Identifier, PastPresence } from '@big-sister'
import { makeExecutableSchema } from 'graphql-tools'
import { GraphQLSchema } from 'graphql'
import { Collector } from './startCollector'
...
export default function stitchSchema(
  ...
  function currentPresence(
    ...
    return collector.getCurrentPresence().presentIdentifiers
  }
